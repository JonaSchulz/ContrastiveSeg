...
if __name__ == "__main__":
    ...
    if configer.get('method') == 'fcn_segmentor':
        if configer.get('phase') == 'train':
            from segmentor.trainer_contrastive_seq import Trainer
    ...
    if configer.exists('save_features'):
        model.save_features()

    elif configer.get('phase') == 'train':
        model.train()
        file_name = configer.get("logging", "log_to_file")
