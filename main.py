...
if __name__ == "__main__":
    ...
    # create Configer object
    #   - set data_dir entry in params_root dicitionary of configer to absolute path
    #   - crete project_dir entry in params_root dictionary f configer (path of main.py)
    ...
    # initialise loggin based on configer parameters
    ...
    # initialise model based on phase specified in configer parameters (train, test, test_offset)
    model = None
    ...
    # run model's train/test function
    if configer.get('phase') == 'train':
        model.train()
