...
class FlipLeft(_BaseTransform):
    ...
    def __call__(self, img, **kwargs):
        ...
        return self._process(img, data_dict, False, left)

    def _crop_flip(self, img, left, *args):
        if left:
    ...
    def _process_img(self, img, left, *args):
        return self._crop_flip(img, left, *args)

    def _process_labelmap(self, x, left, *args):
        return self._crop_flip(x, left, *args)

    def _process_region_indexmap(self, x, *args):
        return self._crop_flip(x, *args)
