...
from lib.loss.loss_contrast import ContrastAuxCELoss, ContrastCELoss, SingleImageContrastCELoss, ContrastCELossSeq
from lib.loss.loss_contrast_mem import ContrastCELoss as MemContrastCELoss
from lib.loss.loss_discrim import DiscrimCELossSeq, DiscrimCELoss
from lib.loss.loss_au import AUCELoss
...
SEG_LOSS_DICT = {
    ...
    'single_image_contrast_ce_loss': SingleImageContrastCELoss,
    ...
    'discrim_ce_loss': DiscrimCELoss,
    'au_ce_loss': AUCELoss,
    'discrim_ce_loss_seq': DiscrimCELossSeq,
    'contrast_ce_loss_seq': ContrastCELossSeq
}
